...
import 'alarm_off_model.dart';
export 'alarm_off_model.dart';

class AlarmOffWidget extends StatefulWidget {
  const AlarmOffWidget({super.key});

  @override
  State<AlarmOffWidget> createState() => _AlarmOffWidgetState();
}

class _AlarmOffWidgetState extends State<AlarmOffWidget> {
  late AlarmOffModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlarmOffModel());
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              ...
              Align(
                alignment: AlignmentDirectional(-0.36, -0.9),
                child: Text(
                  'Alarm Set Up',
