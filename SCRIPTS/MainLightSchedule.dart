...
import 'main_light_schedule_model.dart';
export 'main_light_schedule_model.dart';

class MainLightScheduleWidget extends StatefulWidget {
  const MainLightScheduleWidget({super.key});

  @override
  State<MainLightScheduleWidget> createState() =>
      _MainLightScheduleWidgetState();
}

class _MainLightScheduleWidgetState extends State<MainLightScheduleWidget> {
  late MainLightScheduleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainLightScheduleModel());
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              ...
              Align(
                alignment: AlignmentDirectional(-0.4, 1.83),
                child: InkWell(
                  ...
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(8),
                    child: Image.asset(
                      'assets/images/Captura_de_pantalla_2024-06-02_a_las_13.25.08.png',
                      width: 341,
                      height: 508,
                      fit: BoxFit.cover,
                      alignment: Alignment(-10, -1),
